...
<template>
  <DefineMonthTemplate v-slot="{ date }">
    <Select
      ...
      @update:model-value="value => placeholder = placeholder.set({ month: Number(value) })"
    >
      <SelectTrigger size="sm" class="w-24 border-0 bg-transparent shadow-none">
        <SelectValue />
      </SelectTrigger>
      <SelectContent position="popper">
        <SelectItem v-for="month in createYear({ dateObj: date })" :key="month.toString()" :value="String(month.month)">
  ...
  <DefineYearTemplate v-slot="{ date }">
    <Select
      ...
      @update:model-value="value => placeholder = placeholder.set({ year: Number(value) })"
    >
      <SelectTrigger size="sm" class="w-24 border-0 bg-transparent shadow-none">
        <SelectValue />
      </SelectTrigger>
