export const reviewAnalysisMessages = {
  en: {
    ...
    autoApplied: { SATISFY: 'Marked satisfied automatically', REQUEST_ACTION: 'Returned automatically' }, manualReasons: { ESCALATED: 'Escalated to manual review', LOW_CONFIDENCE: 'Confidence below the request threshold', AMOUNT_MISMATCH: 'Amount calculation did not match' },
  ...
  'zh-CN': {
    ...
    autoApplied: { SATISFY: '已自动标记通过', REQUEST_ACTION: '已自动退回' }, manualReasons: { ESCALATED: '模型已转人工复核', LOW_CONFIDENCE: '置信度未达到本请求阈值', AMOUNT_MISMATCH: '金额重算不一致' },
